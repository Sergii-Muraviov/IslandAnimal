package com.javarush.island.muraviov.entity.ecosystem.animals.herbivores;
...
public class Boar extends Herbivorous{
    ...
    public Boar(OrganismParameters parameters) {
        super(parameters);
    }
    ...
    public boolean eat(Cell cell) {
        ...
        if (this.getCurrentWeight() < getParameters().getMaxWeight()) {
            ...
            for (Types type : types) {
                ...
                if (neededFood > 0 && type == Types.CATERPILLAR || neededFood > 0 && type == Types.MOUSE) {
                    Set<Organism> organisms = cell.getResidents().get(type);
                    Iterator<Organism> iterator = organisms.iterator();
